  ...
  <div class="row">
  	<div class="col-sm-9">
		...
		<div class="col-md-6 text-center">
			<a href="{{ url('/cart/show') }}" class="btn btn-primary col-md-10"><i class="fa fa-shopping-cart"></i> View Cart</a>
			<br><br>
			<a href="{{ url('/cart/checkout') }}" class="btn btn-primary col-md-10"><i class="fa fa-share"></i> Checkout</a>
		</div>
