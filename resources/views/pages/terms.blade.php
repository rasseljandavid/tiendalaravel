    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div id="content" class="col-xs-12">
            ...
            <p>Tienda Enterprises (&ldquo;we,&rdquo; &ldquo;us,&rdquo; &ldquo;our&rdquo;) has established these Terms of Use (&ldquo;Terms&rdquo;) for each customer (&ldquo;you,&rdquo; &ldquo;your&rdquo;), which govern your access to, and use of the www.tienda.ph website (the &ldquo;Services&rdquo;), and any information, text, graphics, or other materials uploaded, downloaded, or appearing on the Services (collectively referred to as &ldquo;Content&rdquo;). By accessing or using the Services you agree to be bound by these Terms.</p>

            <p><strong>Use of the Services</strong></p>
            ...
            <p>You may use the Services if you are of legal age to form a binding contract and are not a person barred from receiving services under the laws of the Republic of Philippines. You may use the Services only in compliance with these Terms and all applicable local, state, national, and international laws, rules and regulations.</p>

            <p>All right, title, and interest in and to the Services are and will remain the exclusive property of the Company and its licensors. The Services are protected by copyright, trademark, and other laws, of both the Republic of Philippines and foreign countries. Nothing in the Terms gives you a right to use the Company&rsquo;s name or any of the Company&rsquo;s trademarks, logos, domain names, and other distinctive brand features, and you may not use the same without our express written permission. Any feedback, comments, or suggestions (&ldquo;Submission&rdquo;) you may provide regarding the Services is entirely voluntary and we will be free to use such Submission as we see fit and without any obligation to you. By making a Submission, you grant us a non-exclusive, royalty-free, perpetual, irrevocable, and fully sub licensable right to use, reproduce, modify, adapt, publish, translate, create derivative works from, distribute, and display such Submission throughout the world in any media. You also grant us the right to use the name you submit in connection with such Submission.</p>
            ...
            <p><strong>Content on the Services</strong></p>
            ...
            <p><strong>Restrictions on the Content and Use of the Services</strong></p>
            ...
            <p>We reserve the right to remove Content in violation of this policy without prior notice and at our sole discretion. Our designated copyright agent for notice of alleged copyright infringement appearing on the Services is: Legal Department, Reagle Retail Inc. and can be reached at help@tienda.ph.</p>
            ...
            <p>These Terms and any action related thereto will be governed by the laws of the Republic of Philippines, without regard to or application of its conflict of law provisions or your state or country of residence. All claims, legal proceedings, or litigation arising in connection with the Services will be brought solely in Philippines, and you consent to the jurisdiction of and venue in such courts and waive any objection as to inconvenient forum.</p>
