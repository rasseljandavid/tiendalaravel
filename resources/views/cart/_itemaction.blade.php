...
<form method="POST" action="{{ url('/cart/addItem') }}" class="update-cart-item">
	...
	<input type="text" id="cart-item-quantity" name="cart_item_quantity" value="{{$oi->quantity}}" size="1" class="form-control" style="width:50% !important; text-align: center;"><button type="submit" data-toggle="tooltip" title="Update" class="btn btn-primary"><i class="fa fa-refresh"></i></button>
</form>
