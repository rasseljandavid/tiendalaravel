...
@section('metainfo')
	<title>Compare Products : Tienda -Your First Online Grocery in the Philippines</title>
  <meta name="description" content="Compare Products : Tienda -Your First Online Grocery in the Philippines">
@endsection
          ...
          <div class="table-responsive">
            <table class="table table-bordered table-hover">
              ...
              <tbody>
                <tr>
                  <td>Product</td>
                  <td><a href="product.html"><strong>Laptop Silver black</strong></a></td>
                  <td><a href="product.html"><strong>Strategies for Acquiring Your Own Laptop</strong></a></td>
                  <td><a href="product.html"><strong>Aspire Ultrabook Laptop</strong></a></td>
                </tr>
                <tr>
                  <td>Image</td>
                  <td class="text-center"><img class="img-thumbnail" title="Laptop Silver black" alt="Laptop Silver black" src="/image/product/macbook_air_1-90x135.jpg"></td>
                  <td class="text-center"><img class="img-thumbnail" title=" Strategies for Acquiring Your Own Laptop " alt=" Strategies for Acquiring Your Own Laptop " src="/image/product/macbook_pro_1-90x135.jpg"></td>
                  <td class="text-center"><img class="img-thumbnail" title="Aspire Ultrabook Laptop" alt="Aspire Ultrabook Laptop" src="/image/product/samsung_tab_1-90x135.jpg"></td>
                </tr>
                <tr>
                  <td>Price</td>
