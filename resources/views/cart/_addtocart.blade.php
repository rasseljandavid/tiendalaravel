...
<div class="qty add-to-cart">
	...
	<form method="POST" action="{{ url('/cart/addItem') }}" class="form form-addtocart">
		...
		<input type="text" name="cart_item_quantity" value="{{ $item->quantity or 0 }}" size="2" id="input-quantity" class="form-control btn-addtocart" readonly /><button type="button" id="submit" class="{{ $btnclass }} btn-addtocart"><span>Add to cart</span></button>
